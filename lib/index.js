...
/**
 * chimee-plugin-contextmenu v0.0.1
 * (c) 2017 huzunjie
 * Released under ISC
 */
...
__$styleInject("vision-menu{position:absolute;color:#fff;background-color:rgba(37,37,37,.7);font-size:13px;font-family:sans-serif;border:1px solid hsla(0,0%,100%,.08);border-radius:2px;padding:2px;box-shadow:0 1px 4px rgba(0,0,0,.6)}vision-menu ul{margin:0;padding:0;font-size:12px}vision-menu li{cursor:pointer;padding:0 4px;line-height:24px;list-style:none;white-space:nowrap;margin:0;border:0;font-size:12px;font-weight:400}vision-menu li:hover{background-color:hsla(0,0%,100%,.1)}vision-menu li[disable]{opacity:.5;cursor:default}", undefined);
 ...
 */
var chimeeContextmenu = popupFactory({
  tagName: 'chimee-menu',
...
module.exports = chimeeContextmenu;
